				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-md-5 col-12">
							<!-- Contact -->
							<ul class="top-link">
								<li><a href="/">LS ADVANCE CALIBRATION SERVICES & SUPPLY</a></li>
							</ul>
							<!-- End Contact -->
						</div>
						<div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="row row-cols-4">
							    <ul class="top-contact">
								    <li><i class="icofont icofont-phone"></i>(+63)9155656265</li>
								    <li><i class="fa fa-envelope-o"></i><a href="#">ls.calibrationservices@gmail.com</a></li>
                                    <li><i class="fa fa-map-o"></i>Fitness Zone Bldg. Circumferential Road, Cor. E. Rodriguez Ave., Brgy. Dalig</li>
							    </ul>
                            </div>
							<!-- End Top Contact -->
						</div>
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											...
											<li class="{{ Request::routeIs('products') ? 'active' : '' }}"><a href="/products">Products</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="single-footer">
								<h2>Main Office</h2>
                                <p>Fitness Zone Bldg. Circumferential Road, Cor. E. Rodriguez Ave., Brgy. Dalig.</p>
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="single-footer">
								<h2>Contact Us</h2>
								<p><i class="fa fa-envelope-o"></i> ls.calibrationservices@gmail.com</p>
                                <p><i class="icofont icofont-phone"></i>(+63)9155656265</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-12">
							<div class="copyright-content">
								<p>© Copyright 2025  |  All Rights Reserved by <a href="#" target="_blank">LS Advance Calibration & Services</a> </p>
							</div>
						</div>
					</div>
				</div>
